...
/***/ function(module, exports, __webpack_require__) {
	...
	soilChart = {
		...
		chartAddEventListener: function chartAddEventListener(eventName, handlerFunction, chartIndex, chartInstanceIndex) {
		...
		chartInstanceAddEventListener: function chartInstanceAddEventListener(eventName, handlerFunction, chartInstanceIndex) {
			if (!chartInstanceIndex) {
				chartInstanceIndex = 0;
			}
		...
		startDataZoomSelect: function startDataZoomSelect() {
			for (var index = 0; index < this.chartInstance.length; index++) {
		...
		stopDataZoomSelect: function stopDataZoomSelect() {
			for (var index = 0; index < this.chartInstance.length; index++) {
				this.chartInstance[index].dispatchAction({
					type: 'takeGlobalCursor',
					key: 'dataZoomSelect',
		...
		getMarkLineSeries: function getMarkLineSeries(value, markLineName) {
			var series;
			...
			if (markLineName == 'warning') {
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '警戒水位:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 2, Number(value).toFixed(2)],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '保证水位:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 4, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '历史最高:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 6, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						...
						normal: {
							postion: [0, 50],
							formatter: function formatter(value) {
								str = '历史最低:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 8, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '正常高:' + Number(value.value).toFixed(2);
								return str;
							}
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '汛限水位:' + Number(value.value).toFixed(2);
								return str;
							}
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '死水位:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 3, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '坝顶高程:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 5, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '兴利水位:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 7, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
				...
				series.markPoint = {
					label: {
						normal: {
							formatter: function formatter(value) {
								str = '校核水位:' + Number(value.value).toFixed(2);
								return str;
							}
					...
					data: [{
						coord: [startDate + tenOne * 9, Number(value).toFixed(2)],
						value: Number(value).toFixed(2),
						name: '水位',
						symbol: 'rect',
						symbolOffset: [0, 0],
		...
		removeZqline: function removeZqline() {
			var Option;
		...
		removeRiverBedline: function removeRiverBedline() {
			var Option;
			Option = soilChart.chartInstance[0].getOption();
			for (var i = 0; i < Option.series.length; i++) {
		...
		//添加标注线
		addMarkLine: function addMarkLine(data, markLineName) {
			var series = this.getMarkLineSeries(data, markLineName);
			this.addSerieToChart(series, 0);
		},
		addSerieToChart: function addSerieToChart(Series, chartIndex) {
		...
		//移除标注线
		removeMarkLine: function removeMarkLine(choiceline) {
		...
		removeSeriesFromeChart: function removeSeriesFromeChart(seriesName, chartIndex) {
			var oldOption = soilChart.chartInstance[chartIndex].getOption();
			var removedSeries = [];
		...
		removeSerieToChart: function removeSerieToChart(choiceline) {
			var oldOption;
		...
		translateJsonTocategory_ValueSeriesData: function translateJsonTocategory_ValueSeriesData(dataArray, xPropertyName, propertyNames) {
			var resultArray = [];
			var xAxisData = [];
			var yAxisData = {};
		...
		//转换
		translateJsonToDate_ValueSeriesData: function translateJsonToDate_ValueSeriesData(dataArray, timePropertyNames, propertyNames) {
			var result = {};
			for (var index = 0; index < propertyNames.length; index++) {
				var seriesData = [];
				for (var i = 0; i < dataArray.length; i++) {
		...
		translateJsonToDateAtHour_ValueSeriesData: function translateJsonToDateAtHour_ValueSeriesData(dataArray, timePropertyNames, propertyNames) {
			var result = {};
			for (var index = 0; index < propertyNames.length; index++) {
				var seriesData = [];
				for (var i = 0; i < dataArray.length; i++) {
		...
		translateJsonToValue_ValueSeriesData: function translateJsonToValue_ValueSeriesData(dataArray, XPropertyNames, propertyNames) {
			var result = {};
			for (var index = 0; index < propertyNames.length; index++) {
				var seriesData = [];
				for (var i = 0; i < dataArray.length; i++) {
		...
		translateObjToArraydata: function translateObjToArraydata(obj, timePropertyNames, propertyName) {
			//到分钟
			var result = [];
		...
		translateObjToArraydataAtHour: function translateObjToArraydataAtHour(obj, timePropertyNames, propertyName) {
			//到小时
			var result = [];
		...
		translateStringToDate: function translateStringToDate(strTm) {
			strTm = strTm.replace(/-/g, "/");
			var date = +new Date(strTm);
			return date;
		},
		translateStringToDateAtHour: function translateStringToDateAtHour(strTm) {
		...
		translateJsonToZ_ZQData: function translateJsonToZ_ZQData(LNNM, Q, Z) {
			var arr = [];
		...
		translateJsonToRZ_WData: function translateJsonToRZ_WData(MSTM, W, RZ) {
			var arr = [];
		...
		translateJsonToRZ_WSFAData: function translateJsonToRZ_WSFAData(MSTM, WSFA, RZ) {
			var arr = [];
		...
		translateJsonToDI_ZBData: function translateJsonToDI_ZBData(MSTM, DI, ZB) {
			var arr = [];
		...
		//update为对外接口函数
		updateRChart: function updateRChart(json, stcd, stnm) {
		...
		updateSChart: function updateSChart(json, stcd, stnm) {
		...
		updateProcChart: function updateProcChart(json) {
		...
		//日雨量
		updateDayRainChart: function updateDayRainChart(json) {
		...
		//小时雨量
		updateHourRainChart: function updateHourRainChart(json) {
		...
		//旬月雨情
		updateMonRainChart: function updateMonRainChart(json) {
			var xAxisData = [];
			var seriesDataUTN = [];
			var seriesDataMTN = [];
			var seriesDataLTN = [];
		...
		//河道水情查询
		updateWaterQueryChart: function updateWaterQueryChart(json, startDate, endDate) {
		...
		updateHistoryWaterQueryChart: function updateHistoryWaterQueryChart(nowjson, historyJson, nowStartDate, nowEndDate, startDate, endDate) {
		...
		//水库水情查询
		updateWaterQueryChartForRsvr: function updateWaterQueryChartForRsvr(json, startDate, endDate) {
		...
		//水库水情查询改y轴
		updateWaterQueryChartForRsvrChangeY: function updateWaterQueryChartForRsvrChangeY(json, startDate, endDate) {
			var data = this.translateJsonToDate_ValueSeriesData(json.rows, 'TM', ['RZ', 'INQ', 'W']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
		...
		updateHistoryWaterQueryChartForRsvr: function updateHistoryWaterQueryChartForRsvr(json, historyJson, startDate, endDate) {
			var data = this.translateJsonToDate_ValueSeriesData(json.rows, 'TM', ['RZ', 'INQ', 'W']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
		...
		//水库水情查询改y轴
		updateHistoryWaterQueryChartForRsvrChangeY: function updateHistoryWaterQueryChartForRsvrChangeY(json, historyJson, startDate, endDate) {
			var data = this.translateJsonToDate_ValueSeriesData(json.rows, 'TM', ['RZ', 'INQ', 'W']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
			var historydata = this.translateJsonToDate_ValueSeriesData(historyJson.rows, 'TM', ['RZ', 'INQ', 'W']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
		...
		//河道雨洪图
		updateRandFChart: function updateRandFChart(json, startDate, endDate) {
		...
		updateHistoryRandFChart: function updateHistoryRandFChart(json, historyJson, startDate, endDate) {
			var data = this.translateJsonToDateAtHour_ValueSeriesData(json.rows, 'TM', ['Z', 'Q', 'P']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
		...
		updateHistoryRandFChartForRsvr: function updateHistoryRandFChartForRsvr(json, historyJson, startDate, endDate) {
		...
		//水库雨洪图
		updateRandFChartForRsvr: function updateRandFChartForRsvr(json, startDate, endDate) {
			var data = this.translateJsonToDateAtHour_ValueSeriesData(json.rows, 'TM', ['RZ', 'INQ', 'P']); //将json对象数据转换为图表option使用的[[x1,y1],[x2,y2]]数据
		...
		updatezqRiverChart: function updatezqRiverChart(tranObjzq) {
		...
		//库容曲线
		updateRsvrrzwChart: function updateRsvrrzwChart(tranObjzq) {
		...
		//大断面高程起点距
		updateRiverBedDIZBChart: function updateRiverBedDIZBChart(tranObjzq) {
		...
		//大断面流量水位
		updateRiverBedZQChart: function updateRiverBedZQChart(tranObjzqD) {
		...
		updateRiverBedZQEmptyChart: function updateRiverBedZQEmptyChart() {
			this.chartInstance[0].setOption(soilChart.soilChartModel.getemptyOption(), true);
		},
		setRiverSectionEmptyChart: function setRiverSectionEmptyChart() {
			this.chartInstance[0].setOption(soilChart.soilChartModel.getSectionEmptyOption(), true);
		},
		getSectionSeriesByData: function getSectionSeriesByData(sectionData) {
			var data = this.translateJsonToDI_ZBData('', sectionData['di'], sectionData['zb']);
			var sectionSeries = {
				name: '断面线',
				type: 'line',
		...
		getWaterLevelSeriesByData: function getWaterLevelSeriesByData(waterData, startIndex, endIndex) {
			var WaterLevelSeries = {
				...
				markPoint: {
					...
					data: [{ coord: [0, waterData], value: Number(waterData).toFixed(2), name: '水位', symbol: 'rect', symbolOffset: [0, -10], symbolSize: [90, 20] }]
				},
				xAxisIndex: 0,
				yAxisIndex: 0,
				lineStyle: {
	...
	soilChart.AxisFunction = __webpack_require__(1);
	soilChart.map = __webpack_require__(3);
	soilChart.soilChartModel = {
		getDayRainOption: function getDayRainOption(data) {
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getHourRainOption: function getHourRainOption(data) {
			var option = {
				tooltip: {
					trigger: 'axis',
					formatter: function formatter(params) {
		...
		getMonRainOption: function getMonRainOption(data) {
			var option = {
				tooltip: {
					trigger: 'axis'
				},
		...
		getRandOption: function getRandOption(data, startTime, endTime) {
			//得到河道雨洪图
			var option = {
				tooltip: {
					trigger: 'axis'
		...
		getHistoryRandOption: function getHistoryRandOption(data, historyData, startTime, endTime) {
			//得到河道雨洪图
			var result = '';
			var option = {
				tooltip: {
		...
		getRandOptionForRsvr: function getRandOptionForRsvr(data, startTime, endTime) {
			//得到水库雨洪图
			var option = {
				tooltip: {
					trigger: 'axis'
		...
		getFandOption: function getFandOption(data, startTime, endTime) {
			//得到河道雨洪图
			var option = {
				tooltip: {
					trigger: 'axis'
		...
		getHistoryFandOption: function getHistoryFandOption(data, historydata, startTime, endTime) {
			//得到河道雨洪图
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getHistoryFandOptionForRsvr: function getHistoryFandOptionForRsvr(data, historydata, startTime, endTime) {
			//得到河道雨洪图
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getFandOptionForRsvr: function getFandOptionForRsvr(data, startTime, endTime) {
			//得到水库雨洪图
			var option = {
				tooltip: {
					trigger: 'axis'
		...
		getWaterQueryOption: function getWaterQueryOption(data, startTime, endTime) {
			//得到河道水情过程线
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getHistoryWaterQueryOption: function getHistoryWaterQueryOption(nowData, historyData, nowStartDate, nowEndDate, startTime, endTime) {
			//得到河道水情过程线
			var result = '';
			var option = {
				tooltip: {
		...
		getWaterQueryOptionForRsvr: function getWaterQueryOptionForRsvr(data, startTime, endTime) {
			//得到水库水情过程线
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getHistoryWaterQueryOptionForRsvr: function getHistoryWaterQueryOptionForRsvr(data, historydata, startTime, endTime) {
			//得到水库水情过程线
			var result = '';
			var option = {
				tooltip: {
		...
		getWaterQueryOptionForRsvrChangeY: function getWaterQueryOptionForRsvrChangeY(data, startTime, endTime) {
			//得到改变y轴后的水库水情过程线
			var option = {
				tooltip: {
					trigger: 'axis',
		...
		getHistoryWaterQueryOptionForRsvrChangeY: function getHistoryWaterQueryOptionForRsvrChangeY(data, historyData, startTime, endTime) {
			//得到改变y轴后的水库水情过程线
			var result = '';
			var option = {
				tooltip: {
		...
		getzqRiverOption: function getzqRiverOption(data, LNNM) {
		...
		//库容曲线chart
		getrzwRiverOption: function getrzwRiverOption(data, dataw, MSTM) {
			var qmin = Number.MAX_VALUE;
			var qmax = Number.MIN_VALUE;
			var max = Number.MIN_VALUE;
			var min = Number.MAX_VALUE;
		...
		getSectionEmptyOption: function getSectionEmptyOption() {
			//大断面起点距高程
			var Option = {
				animation: false,
				color: ['#c23531', '#314656', '#61a0a8', '#dd8668', '#91c7ae', '#6e7074', '#61a0a8', '#bda29a', '#44525d', '#c4ccd3'],
		...
		//断面
		getemptyOption: function getemptyOption() {
			//大断面起点距高程
			var Option = {
				color: ['#c23531', '#314656', '#61a0a8', '#dd8668', '#91c7ae', '#6e7074', '#61a0a8', '#bda29a', '#44525d', '#c4ccd3'],
				title: {
		...
		getRiverBedSeries: function getRiverBedSeries(data, name) {
			var series;
			series = {
				name: name,
				type: 'line',
		...
		getRiverBedZQSeries: function getRiverBedZQSeries(data, name) {
			var series;
			series = {
				name: name,
				type: 'line',
...
/***/ function(module, exports, __webpack_require__) {
	...
	axisModule = {
		...
		ruleTheYAxis: function ruleTheYAxis(option, ruleYAxisIndex, axisPurpose, spiltNumber) {
			/*
	  ...
	  */
			...
			var ruleUseSeries = option.series.map(function (item) {
				//获得与目标轴相关的series数据
			...
			var max = Number.MIN_VALUE;
			var min = Number.MAX_VALUE;
			for (var i = 0; i < ruleUseSeries.length; i++) {
				//循环涉及的series获取N个数据的极值
			...
			if (typeof spiltNumber == "undefined") {
				//即不给定分割段数的规范化方法
		...
		getRuledextremum: function getRuledextremum(max, min, axisPurpose) {
			/*
	  *	方法说明：规范化最大最小值
	  ...
	  */
		...
		getRuledextremumForNew: function getRuledextremumForNew(max, min, axisPurpose, interval) {
			/*
	  *	方法说明：再次规范化最大最小值
	  *	参数说明：        max - 需要规范的最大值(数据实际最大值)
	  					 				 min - 需要规范的最小值(数据实际最小值)
...
/***/ function(module, exports) {
	...
	numberFunctionalModulealModule = {
			getExtremum: function getExtremum(seriesData) {
					/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var districtCode = 'jiangxi_36';
	var districtGeoDataPath = './districtGeoData/districtGeoData_' + districtCode;
	var districtGeoData = __webpack_require__(5);
	var mapModule = {
	    ...
	    getMapGEOJSONByAjax: function getMapGEOJSONByAjax(addvcd, callBackFunction, contextPathString) {
